            ...
            <div className='fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-rgba-black'>
                <form className='bg-white p-6 rounded-md w-2/6' onSubmit={handleSubmit}>
                    ...
                    <div className='mt-3'>
                        ...
                        <div className=' mt-2'>
                            <div className='mb-2 '>
                                {user.avatar && <img src={imageUrl} height={100} width={100} style={{ borderRadius: "50%" }} alt="" />}
                            </div>
                            <Upload {...props}>
                    ...
                    <div className='mt-3'>
                        ...
                        <Input placeholder="Mật khẩu" className='mt-2' name='password' id='password' type='password' onChange={handleInputChange} />
                    </div>
                    <div>
