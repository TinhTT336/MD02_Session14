...
export default function Signup() {
    ...
    const handleSubmit = (e) => {
        ...
        if (!user.user_name) {
            ...
            return;
        } else if (!validateEmailalidateEmail(user.email)) {
            notification.error({
                message: "Cảnh báo",
            ...
            // goi API thêm
            axios.post("http://localhost:3000/users", { ...user, gender: gender })
                .then(response => {
            ...
            <div className='fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-rgba-black'>
                <form className='bg-white p-6 rounded-md w-2/6' onSubmit={handleSubmit}>
                    ...
                    <div className='mt-3'>
                        ...
                        <Input placeholder="Họ và tên" className='mt-3' name='name' id='name' onChange={handleInputChange} />
                    </div>
                    <div className='mt-3'>
