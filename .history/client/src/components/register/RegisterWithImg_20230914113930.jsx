    ...
    const handleSubmit = (e) => {
        ...
        if (user.user_name && user.email && user.password && user.confirmPassword) {
            const newUser = {
                ...
                password,
                role: 1,
                avatar: imageUrls[imageUrls.length - 1],
            }
            localStorage.setItem("userRegister", (newUser));
                        ...
                        <div className='w-50'>
                            <div className='form-group mb-3'>
                                ...
                                <div style={{ display: "flex", gap: 10, }}>
                                    <img src={imageUrls[imageUrls.length - 1]} alt="anh" key={imageUrls} height={100} width={100} style={{ objectFit: "cover", borderRadius: "50%" }} />
                                </div >
